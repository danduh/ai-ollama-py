...
def completions_handle_data(engine_name: str):
    if request.is_json:
        generic_engine = app.config['preprocessed_data'][engine_name]
...
def completions_engine():
    return completions_handle_data('consolidated_engine')
